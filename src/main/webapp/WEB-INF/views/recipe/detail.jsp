                 ...
                 <tbody>
                   ...
                   <tr>
                     <td colspan="2" class="text-left" v-if="rStore.upReplyNo===rvo.no">
			               ...
			               <button type="button" class="btn-success" style="width: 100px;height: 107px;float:left" @click="rStore.replyUpdate(rvo.no)">
			               	  수정
			               </button>
                     </td>
                   </tr>
         ...
         <tbody>
           <tr>
             <td>
               ...
               <button type="button" class="btn-success" style="width: 100px;height: 107px;float:left" @click="rStore.replyInsert()">
               	  댓글쓰기
               </button>
             </td>
           </tr>
